...
public class EmpConsoleUtil {
    ...
    public void printEmp(EmpDTO dto) {
        // dto 내용 출력
        System.out.println(dto.getEname() + " 사원"); // smith 사원
        System.out.println("========================"); // ========================
        System.out.println("사원: " + dto.getEmpno()); // 사원: 7788
    ...
    public EmpDTO updateInfo(Scanner sc) {
        // 수정할 정보 입력받기 => 입력받은 정보 EmpDTO 담은 후 리턴
        ...
        // return new EmpDTO(empno, null, null, empno, null, sal, comm, null);
    }
