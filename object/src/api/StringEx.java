...
public class StringEx {
    public static void main(String[] args) {
        ...
        String str5 = "fg";
        str = str + str5; // 기존의 str을 파괴하고 다시 인스턴스 생성 후 연결함
        ...
        // 5. indexOf(찾을 문자): 주어진 문자의 시작 위치 리턴 / 못 찾으면 -1 => index는 0부터 시작
        // 5. indexOf(찾을 문자, 시작 위치): 주어진 문자의 시작 위치 리턴 / 못 찾으면 -1 => index는 0부터 시작
        ...
        // 10. replace(): old 문자를 new 문자로 변경 후 새로운 문자열로 리턴
        str1 = "Hellollo";
        ...
        arr = animals.split(",", 2);
        for (String string : arr) {
            System.out.println(string); // cat / dog,bear
        }
        ...
        // 15. valueOf(): 기본형(char, int, float, double, boolean) 값을 String으로 전환
